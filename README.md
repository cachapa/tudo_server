...
This project is the server counterpart to the [tudo app](https://github.com/cachapa/tudo_client).
...
* This project isn't suited for serverless hosting (e.g. Amazon Lambda, Google Cloud Run):
  * All client data is kept in volatile memory and lost when the process goes down
  * The server uses websockets for long-running sessions
